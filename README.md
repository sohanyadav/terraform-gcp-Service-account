...
module "service-account" {
  source                             = "https://github.com/sohanyadav/terraform-gcp-Service-account.git"
  name                               = "dev"
  environment                        = "test"
...
# Examples
For detailed examples on how to use this module, please refer to the [example](https://github.com/sohanyadav/terraform-gcp-Service-account/tree/master/_example) directory within this repository.
...
## License
This project is licensed under the MIT License - see the [LICENSE](https://github.com/sohanyadav/terraform-gcp-Service-account/blob/master/LICENSE) file for details.
